...
from progent.core import update_security_policy, reset_security_policy, check_tool_call
...
class TestPolicyPriorityOrdering:
    ...
    def test_higher_priority_rule_wins(self):
        ...
        policy = {
            "test_tool": [
                (1, 0, {"arg": {"type": "string", "pattern": "^allow"}}, 0),  # Priority 1: allow "allow*"
                (2, 1, {"arg": {"type": "string", "pattern": "^allow"}}, 0),  # Priority 2: deny "allow*"
            ]
        }
    ...
    def test_fallback_is_respected(self):
        ...
        policy = {
            "test_tool": [
                (1, 0, {"arg": {"type": "string", "pattern": "^specific"}}, 1),  # Match "specific*", fallback=deny
            ]
        }
        update_security_policy(policy)
