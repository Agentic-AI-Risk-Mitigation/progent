...
def test_validate_unknown_argument():
    tools = [{"name": "my_tool", "description": "desc", "args": {"valid_arg": {"type": "string"}}}]
    policy = {"my_tool": [(1, 0, {"invalid_arg": "value"}, 0)]}
...
def test_validate_type_specific_keyword_misuse():
    tools = [{"name": "my_tool", "description": "desc", "args": {"arg1": {"type": "string"}}}]
    policy = {
        "my_tool": [
